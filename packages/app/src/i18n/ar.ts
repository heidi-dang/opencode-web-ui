...
export const dict = {
  ...
  "fleet.drawer.projectsCount": "{{open}} open u00B7 {{known}} known on server",
  "fleet.drawer.providersCount": "{{connected}} connected u00B7 {{configured}} configured",
  "fleet.label.url": "URL",
  ...
  "session.status.workingCompact": "جارٍ العمل…",
  "session.status.accessibleName": "الذكاء الاصطناعي يعمل",
  "session.status.working.1": "جارٍ تحليل طلبك…",
  "session.status.working.2": "جارٍ قراءة التعليمات البرمجية…",
  "session.status.working.3": "جارٍ إعداد خطة…",
  "session.status.tool.1": "جارٍ تشغيل أداة…",
  "session.status.tool.2": "جارٍ تنفيذ العملية…",
  "session.status.tool.3": "جارٍ استدعاء الدالة…",
  "session.status.shell.1": "جارٍ تشغيل الأمر…",
  "session.status.shell.2": "جارٍ تنفيذ برنامج shell…",
  "session.status.shell.3": "جارٍ تنفيذ bash…",
  "session.status.file.1": "جارٍ قراءة الملف…",
  "session.status.file.2": "جارٍ تحليل محتويات الملف…",
  "session.status.file.3": "جارٍ فحص التعليمات البرمجية…",
  "session.status.text.1": "جارٍ كتابة الرد…",
  "session.status.text.2": "جارٍ إنشاء التعليمات البرمجية…",
  "session.status.text.3": "جارٍ إعداد المخرجات…",
  "session.status.step.1": "جارٍ تخطيط الخطوة التالية…",
  "session.status.step.2": "جارٍ تقييم النهج…",
  "session.status.step.3": "جارٍ تحديد الإجراء التالي…",
}
