export const dict = {
  "autonomousWorkspace.title": "Autonomous workspace",
  "autonomousWorkspace.toggle.enable": "Enable autonomous workspace",
  "autonomousWorkspace.toggle.disable": "Disable autonomous workspace",
  "autonomousWorkspace.description": "Conversation, execution, review, and runtime intelligence",
  "autonomousWorkspace.views.label": "Workspace views",
  "autonomousWorkspace.views.conversation": "Conversation",
  "autonomousWorkspace.views.lineage": "Session lineage",
  "autonomousWorkspace.views.timeline": "Timeline",
  "autonomousWorkspace.views.changes": "Changes",
  "autonomousWorkspace.views.context": "Context",
  "autonomousWorkspace.common.unavailable": "Unavailable",
  "autonomousWorkspace.lineage.title": "Session lineage",
  "autonomousWorkspace.lineage.description": "Derived from authoritative session relationships",
  "autonomousWorkspace.lineage.count": "Sessions: {{count}}",
  "autonomousWorkspace.lineage.treeLabel": "Session lineage",
  "autonomousWorkspace.lineage.unavailable": "Session lineage is unavailable.",
  "autonomousWorkspace.lineage.relation.current": "Current session",
  "autonomousWorkspace.lineage.relation.derived": "Derived relationship",
  "autonomousWorkspace.timeline.title": "Execution timeline",
  "autonomousWorkspace.timeline.description": "Normalized activity from the session runtime",
  "autonomousWorkspace.timeline.count": "Events: {{count}}",
  "autonomousWorkspace.timeline.listLabel": "Execution events",
  "autonomousWorkspace.timeline.empty": "No execution events available.",
  "autonomousWorkspace.timeline.event.tool": "Tool activity",
  "autonomousWorkspace.timeline.event.shell": "Shell activity",
  "autonomousWorkspace.timeline.event.step": "Assistant step",
  "autonomousWorkspace.timeline.event.retry": "Retry",
  "autonomousWorkspace.timeline.event.configuration": "Session configuration",
  "autonomousWorkspace.timeline.event.permission": "Permission request",
  "autonomousWorkspace.timeline.event.question": "Question request",
  "autonomousWorkspace.timeline.event.changes": "File changes",
  "autonomousWorkspace.timeline.event.session": "Session activity",
  "autonomousWorkspace.timeline.duration": "{{duration}} ms",
  "autonomousWorkspace.timeline.state.active": "Active",
  "autonomousWorkspace.timeline.state.completed": "Completed",
  "autonomousWorkspace.timeline.state.failed": "Failed",
  "autonomousWorkspace.timeline.state.cancelled": "Cancelled",
  "autonomousWorkspace.context.title": "Context intelligence",
  "autonomousWorkspace.context.description": "Only values provided by the runtime are shown.",
  "autonomousWorkspace.context.provider": "Provider",
  "autonomousWorkspace.context.model": "Model",
  "autonomousWorkspace.context.inputTokens": "Input tokens",
  "autonomousWorkspace.context.outputTokens": "Output tokens",
  "autonomousWorkspace.context.reasoningTokens": "Reasoning tokens",
  "autonomousWorkspace.context.cacheReadTokens": "Cache read tokens",
  "autonomousWorkspace.context.cacheWriteTokens": "Cache write tokens",
  "autonomousWorkspace.context.totalTokens": "Total tokens",
  "autonomousWorkspace.context.cost": "Cost",
  "autonomousWorkspace.changes.title": "Changes & review",
  "autonomousWorkspace.changes.description": "Runtime-backed file changes only",
  "autonomousWorkspace.changes.count": "Files: {{count}}",
  "autonomousWorkspace.changes.empty": "No changes available.",
  "autonomousWorkspace.changes.additions": "+{{count}}",
  "autonomousWorkspace.changes.deletions": "−{{count}}",
  "autonomousWorkspace.changes.status.added": "Added",
  "autonomousWorkspace.changes.status.modified": "Modified",
  "autonomousWorkspace.changes.status.deleted": "Deleted",
  "autonomousWorkspace.changes.status.renamed": "Renamed",
  "autonomousWorkspace.changes.status.unsupported": "Unsupported",
  "autonomousWorkspace.changes.status.unknown": "Unknown",
