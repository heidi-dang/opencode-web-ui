export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Heidi",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Heidi.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "Heidi Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Heidi.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Heidi.",
  ...
  "wsl.onboarding.step.opencode": "Heidi",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Heidi...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Heidi in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Heidi...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Heidi in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Heidi in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Heidi",
  "wsl.onboarding.opencodeReadyIn": "Heidi is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Heidi is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Heidi in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Heidi",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Heidi not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Heidi can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Heidi could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Heidi.",
  ...
  "fleet.filter.online": "Online",
  "fleet.filter.degraded": "Degraded",
  "fleet.filter.offline": "Offline",
  "fleet.filter.authIssue": "Auth Issue",
  "fleet.connectionType.all": "All Types",
  "fleet.connectionType.http": "HTTP",
  "fleet.connectionType.sidecar": "Sidecar",
  "fleet.connectionType.wsl": "WSL",
  "fleet.connectionType.ssh": "SSH",
  "fleet.sort.state": "Status",
  "fleet.sort.name": "Name",
  "fleet.sort.latency": "Latency",
  "fleet.sort.sessions": "Sessions",
  "fleet.sort.projects": "Projects",
  "fleet.search.placeholder": "Search servers...",
  "fleet.servers.count": "{{current}} / {{total}} servers",
  "fleet.summary.online": "online",
  "fleet.summary.degraded": "degraded",
  "fleet.summary.offline": "offline",
  "fleet.summary.activeSessions": "active sessions",
  "fleet.summary.blocked": "blocked",
  "fleet.summary.refreshAll": "Refresh All",
  "fleet.summary.refreshing": "Refreshing...",
  "fleet.card.sessions": "sessions",
  "fleet.card.blocked": "blocked",
  "fleet.card.projects": "projects",
  "fleet.card.providers": "providers",
  "fleet.card.refresh": "Refresh",
  "fleet.card.open": "Open",
  "fleet.card.edit": "Edit",
  "fleet.card.details": "Details",
  "fleet.empty.title": "No servers connected",
  "fleet.empty.description": "Add a server in Settings to get started.",
  "fleet.drawer.title": "Server details",
  "fleet.drawer.close": "Close dialog",
  "fleet.drawer.overview": "Overview",
  "fleet.drawer.projects": "Projects",
  "fleet.drawer.sessions": "Sessions",
  "fleet.drawer.providers": "Providers",
  "fleet.drawer.diagnostics": "Diagnostics",
  "fleet.drawer.refresh": "Refresh Health",
  "fleet.drawer.running": "Running",
  "fleet.drawer.busy": "Busy",
  "fleet.drawer.permissionBlocked": "Permission blocked",
  "fleet.drawer.questionBlocked": "Question blocked",
  "fleet.drawer.totalActive": "Total active",
  "fleet.drawer.projectsCount": "{{open}} open \u00B7 {{known}} known on server",
  "fleet.drawer.providersCount": "{{connected}} connected \u00B7 {{configured}} configured",
  "fleet.label.url": "URL",
  "fleet.label.label": "Label",
  "fleet.label.connection": "Connection",
  "fleet.label.protocol": "Protocol",
  "fleet.label.version": "Version",
  "fleet.label.latency": "Latency",
  "fleet.label.lastCheck": "Last check",
  "fleet.page.lastUpdated": "Last updated {{time}}",
  "fleet.page.loading": "Loading fleet...",
  "fleet.summary.totalServers": "servers",
  "fleet.summary.ariaLabel": "Fleet summary",
  "fleet.summary.activeSessionsTooltip": "Total active sessions across all servers",
  "fleet.summary.blockedTooltip": "Sessions blocked by permission requests or questions",
  "fleet.sort.label": "Sort by",
  "fleet.sort.updated": "Last updated",
  "fleet.search.clear": "Clear search",
  "fleet.filter.statusGroup": "Status filter",
  "fleet.filter.clear": "Clear filters ({{count}})",
  "fleet.card.serverLabel": "Server",
  "fleet.card.viewDetails": "View details for {{name}}",
  "fleet.noResults.title": "No servers match your filters",
  "fleet.noResults.description": "Try adjusting your search, status filter, or connection type.",
  "fleet.noResults.clearFilters": "Clear all filters",
  "fleet.announce.refreshing": "Refreshing fleet servers...",
  "fleet.announce.refreshComplete": "Fleet refresh complete. {{count}} servers.",
  "fleet.drawer.connection": "Connection",
  "fleet.drawer.health": "Health",
  "fleet.drawer.actions": "Actions",
  "fleet.drawer.copy": "Copy",
  ...
  "app.name.desktop": "Heidi Desktop",
  ...
  "settings.desktop.wsl.description": "Run the Heidi server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Heidi",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Heidi looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Heidi follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Heidi is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Heidi launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Heidi.",
  ...
  "better-harness.nav": "Better Harness",
  ...
  "better-harness.unavailable.description": "The Better Harness analysis engine is not available on this server.",
  "better-harness.unavailable.no-flowdeck": "FlowDeck is not installed on this server.",
  ...
  "better-harness.finding.cause": "Cause",
  "better-harness.finding.impact": "Impact",
  "better-harness.finding.expected": "Expected Output",
  "better-harness.finding.evidence": "Evidence",
  "better-harness.finding.paths": "Affected Paths",
  "better-harness.finding.vehicle": "Recommended Repair",
  "better-harness.finding.plan-fix": "Plan Fix",
  "better-harness.finding.verify": "Verify",
  "better-harness.finding.ignore": "Ignore",
  "better-harness.finding.batch-plan-fix": "Batch Plan Fix",
  "better-harness.finding.batch-verify": "Batch Verify",
  "better-harness.finding.batch-ignore": "Batch Ignore",
  "better-harness.finding.ignore-reason": "Ignore Reason",
  "better-harness.filter.all": "All",
  "better-harness.filter.pending": "Pending",
  "better-harness.filter.in-progress": "In Progress",
  "better-harness.filter.fixed": "Fixed",
  "better-harness.filter.ignored": "Ignored",
  "better-harness.sort.recent": "Most Recent",
  "better-harness.sort.severity": "Severity",
  "better-harness.sort.dimension": "Dimension",
  "better-harness.priority.critical": "Critical",
