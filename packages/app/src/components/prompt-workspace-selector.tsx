    ...
    <>
      ...
      <MenuV2 placement="bottom" gutter={4} onOpenChange={onOpenChange}>
        <MenuV2.Trigger
          ...
          aria-label={`${language.t("session.new.workspace.runIn")}: ${label()}`}
        >
    ...
    <Show when={label()}>
      {(value) => (
        <>
          ...
          >
            <div class="flex h-7 min-w-0 max-w-[220px] items-center gap-1.5 px-2 text-[13px] font-body leading-5 tracking-v2">
